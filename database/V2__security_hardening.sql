ALTER TABLE appointments ADD COLUMN IF NOT EXISTS cancel_token_hash CHAR(128);
...
UPDATE appointments SET cancel_token_hash = encode(gen_random_bytes(48), 'hex') WHERE cancel_token_hash IS NULL;
